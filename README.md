...
Design note (for manual layout):

- Wireframe showing the full exhibition, including 5 posters, 2 books on a
  table, web app (graphic of a phone/tablet), and Data Detox Kits.

![Full exhibition wireframe](_readme_imgs/1-Overall.png)
...
![Online Harassment poster web app](_readme_imgs/2-OH-webapp.png)
![Interactive spectrogram poster](_readme_imgs/5-Spectrogram.png)
...
- Wireframe close-up of the 5 posters. There should be someone exploring Online
  Harassment with their smartphone, and the spectrogram should have some
  stickers already on it. People can be exploring the other works.
- Wireframe of a table (aerial view) with the two books (labels "families" and
  "workers") and intro/outro cards. Someone checking out the book.
- Wireframe of Data Detox Kits in someone's hand.
...
- Wireframe showing posters hanging, with round sticker pack below the
  spectrogram poster.
- Graphic showing introduction placard being taped to the table.
